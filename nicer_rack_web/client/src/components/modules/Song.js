...
const Song = (props) => {
  ...
  function handleQueueAdd(event) {
    ...
    var add_queue_url = 'http://nicerack.mit.edu/add_song_queue/' + props.link;
    fetch(add_queue_url)
  ...
  function handleQueueRemove(event) {
    ...
    var remove_queue_url = 'http://nicerack.mit.edu/remove_song_queue/' + props.link + '/' + props.queue_index;
